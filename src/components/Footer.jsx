            ...
            <ul className="space-y-3">
              {[
                ...
                <li key={link.to}>
                  <Link
                    to={link.to}
                    className="text-gray-600 dark:text-gray-400 hover:text-green-600 dark:hover:text-green-400 text-sm transition-colors duration-300 hover:translate-x-1 transform inline-block"
                  >
                    {link.label}
                  </Link>
                </li>
            ...
            <div className="grid grid-cols-4 gap-3 mb-6">
              {[
                ...
                <motion.a
                  ...
                  whileTap={{ scale: 0.9 }}
                  className={`text-gray-500 dark:text-gray-400 ${social.color} transition-all duration-300 p-2 rounded-lg hover:bg-gray-100 dark:hover:bg-gray-800 flex items-center justify-center`}
                  title={social.title}
                >
                  <social.icon size={20} />
          ...
          <div className="max-w-md mx-auto text-center">
            ...
            <div className="flex space-x-2">
              <input
                ...
                className="flex-1 px-4 py-2 border border-gray-200 dark:border-gray-600 rounded-lg focus:outline-none focus:ring-2 focus:ring-green-500 focus:border-transparent bg-white dark:bg-gray-700 text-gray-900 dark:text-gray-100 placeholder-gray-500 dark:placeholder-gray-400 transition-all duration-300"
              />
          ...
          <div className="flex space-x-6">
            {[
              ...
              <Link
                key={link.to}
                to={link.to}
                className="text-xs text-gray-600 dark:text-gray-400 hover:text-green-600 dark:hover:text-green-400 transition-colors duration-300"
              >
                {link.label}
              </Link>
            ))}
